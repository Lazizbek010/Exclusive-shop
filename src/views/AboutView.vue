    ...
    <div class="container container__about">
        <div class="about-left__parent">
            ...
            <div class="about-right__img">
                <img src="../assets/images/png/About_page-img.jpg" alt="" width="220px" height="300px">
        ...
        <div class="customer-about__cards">
            <div class="customer-about__card " v-for="card in 4" :key="card">
        ...
        <!-- customer_about_page-end -->

        <div class="people-section__cards">
            <div class="people-item__card" v-for="card in 3" :key="card">
                ...
                <div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g clip-path="url(#clip0_1310_3570)">
                            <path
                                ...
                                fill="white" stroke="555" stroke-width="0.2" />
                        </g>
                        <defs>
                            <clipPath id="clip0_1310_3570">
                                <rect width="24" height="24" fill="white" />
                            </clipPath>
                        </defs>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
                        <path stroke="#888" stroke-linejoin="round" stroke-width="1.5"
